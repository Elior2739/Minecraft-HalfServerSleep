...
public class utils {
	...
	public static class Messages {
		...
		public static String player_exited_from_sleep = ChatColor.translateAlternateColorCodes('&', Main.getPlugin(Main.class).getConfig().getString("Messages.player_exited_from_sleep"));
		public static String all_needed_players_sleep = ChatColor.translateAlternateColorCodes('&', Main.getPlugin(Main.class).getConfig().getString("Messages.all_needed_players_sleep"));
	}
